    ...
    <div>
      <header className="pokedex__header">
        ...
        <p className="pokedex-p">
          <span className="pokedex-span">Bienvenido {trainer}</span>, aquí podrás encontrar tu pokemón favorito
        </p>
      </header>
      <section className="pokedex__section">
        <form className='pokedex__form' onSubmit={handleSubmit}>
          <input className='pokedex__input' id="search" type="text" placeholder='Busca un pokemón'/>
          <button className='pokedex__btn'>Buscar</button>
        </form>
        <select className='pokedex__select' onChange={handleChange}>
          <option className='pokedex__option' value="All pokemons">Tipos de pokemon</option>
          {types?.map((type) => (
